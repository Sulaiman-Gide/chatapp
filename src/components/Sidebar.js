  ...
  const chatList = () => {
    ...
    if (user) {
      return (
        ...
        .map(
          chat => 
            <div key={chat.id} onClick={() => redirect(chat.id)} className='chatList dark:bg-gray-900 shadow-md bg-slate-50/25 flex items-center justify-start rounded-lg py-3 px-3 my-3 mr-2'>
